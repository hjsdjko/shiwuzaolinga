...
public class GuangrongbangView extends GuangrongbangEntity implements Serializable {
	...
	public GuangrongbangView() {

	}

	public GuangrongbangView(GuangrongbangEntity guangrongbangEntity) {
		try {
			BeanUtils.copyProperties(this, guangrongbangEntity);
